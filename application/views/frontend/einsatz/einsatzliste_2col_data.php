...
?> 
            <div class="listContent">
				...
				<div class="row">
                	...
                	<div class="date trenner<?=$special_class?>"><a href="<?=base_url('einsatz/'.$id)?>"><span class="inline_date"><?=cp_get_ger_date($datum_beginn)?></span> <span class="inline_slash">/</span> <span class="inline_time"><?=$uhrzeit_beginn?> Uhr</span></a></div>
                	<div class="icon trenner<?=$special_class?>"><a href="<?=base_url('einsatz/'.$id)?>" class="<?=$type_class?>"><?=$type_class?></a></div>
                	<div class="headline<?=$special_class?>"><a href="<?=base_url('einsatz/'.$id)?>"><?=$name?></a></div>
