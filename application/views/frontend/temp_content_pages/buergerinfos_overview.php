<?php if (!defined('BASEPATH')) exit('No direct script access allowed'); ?>
 ...
 <div class="oneColumnBox">
                <ul class="TeaserListe">
                    <a href="<?=base_url('informationen/buergerinformationen/blaulicht')?>">
                    <li class="text">
                        <figure class="border">
                            <img src="<?=base_url('images/content/content_buergerinfos/blaulicht.jpg')?>" />
                        </figure>
                        <h1>Blaulicht und Martinshorn</h1>
