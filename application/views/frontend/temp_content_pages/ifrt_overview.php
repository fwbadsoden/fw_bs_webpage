...
Die zweite Gruppe saß natürlich nicht einfach rum, sondern wurde ebenfalls gleich zu Beginn "rangenommen", wobei "eingeheizt" vermutlich der treffendere Ausdruck wäre. Für die Kameradinnen und Kameraden stand der sogenannte Flash-Over Container auf dem Programm. Dieser eigens von den Ausbildern erbaute Hochseecontainer wurde so umgebaut, dass der Flash-Over unter Realbedingungen gezeigt werden konnte. Die mit Atemschutzgeräten ausgerüsteten Feuerwehrfrauen und -männer setzten sich hierzu auf den Boden des Containers und konnten das mit Holzpaletten angezündete Feuer beobachten. Sobald nun ein Ausbilder die große Stahltür und damit die Sauerstoffzufuhr öffnete, konnte man die Feuerwalze über den Köpfen hinweg beobachten. Diese Demonstration war für diejenigen, die das zum ersten Mal gesehen haben nicht nur eindrucksvoll, sondern zeigte auch, was unsere Schutzkleidung alles aushalten muss.
                ...
                <img src="<?=base_url('images/content/ifrt_03.JPG')?>" title="Alles OK" />
                <p>
                ...
                <img src="<?=base_url('images/content/ifrt_02.JPG')?>" title="TH VU" />
                <p>
                ...
                <p>
                    Am nächsten Morgen, nach einem ausgiebigen Frühstück, wurde die letzte Etappe eingeläutet. Die "Verkehrsunfall-Gruppe" bekam noch einmal vier verschiedene Einsatzübungen vorgelegt, welche abgearbeitet werden mussten. Die Ausbilder zeigten hier, dass sie es ernst meinten und zündeten gleich mehrmals einen Teil der PKWs an, welche dann schnellst möglichst gelöscht werden mussten.
Die zweite Gruppe hatte die Aufgabe, truppweise (zu zweit) einen verrauchten Container nach Personen abzusuchen. Wenn diese Aufgabe geschafft war, musste noch das Feuer ein Stockwerk darunter gelöscht werden. Gerade hier wurde den Kameradinnen und Kameraden einiges abverlangt, da Temperaturen von bis zu 600° C und sogar darüber entstanden sind. Sobald das Wasser dann auf das Feuer traf, entstand der noch wärmere Wasserdampf. "Hierbei gilt es nicht, die Feuerwehrleute zu verheizen, sondern ihnen klar zu machen, wie warm es tatsächlich bei einem Zimmerbrand werden kann", sagten die Ausbilder immer wieder.
                </p>
                <p>
        ...
        <div id="SidebarContent">   
           	<div class="address">
				<h1 class="first">Kontakt zu IFRT</h1>
				<p>International<br/>Fire & Rescue<br/>Training</p>
				<p>Siemensstraße 8<br/>97900 Külsheim</p>
				<ul>
					<li class="tel">+49 711 34211473</li>
                    <li class="fax">+49 711 34211474</li></li>
					<li class="mail"><a href="mailto:info@ifrt.org">info@ifrt.org</a></li>
					<li class="mail"><a href="http://www.ifrt.org" target="_blank">www.ifrt.org</a></li>
				</ul>
                <br />
			</div>    
		</div>
