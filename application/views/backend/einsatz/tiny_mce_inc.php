<script type="text/javascript">
        $(function() {
                $('textarea.tinymce').tinymce({
                        ...
                        // General options
                        theme : "advanced",
                        plugins : "style,layer,table,save,advhr,advimage,advlink,iespell,inlinepopups,preview,media,searchreplace,contextmenu,paste,directionality,noneditable,visualchars,nonbreaking,xhtmlxtras",
