...
<div id="content">
<p class="thirdMenue">
	<a href="<?=base_url('admin/content/page/create')?>" class="button_gross"><span class="button_add">Neue Seite anlegen</span></a>
</p>
<p>&nbsp;</p>
...
<?	} ?>
	...
	<td class="button"><span id='jquery-tools-tooltip'><a id="confirm_link_<?=$item['pageID']?>" href="<?=base_url('admin/content/page/delete/'.$item['pageID'])?>" class="button_mini" title="Seite löschen"><span class='button_delete_small'></span></a></span></td>
</tr>
<?
    $i++; 
  } 
