...
*/
	...
	*/ 
	$config['database']['user_acc']['table'] = 'user_account';
	$config['database']['user_acc']['join'] = 'user_account.uacc_id';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_group']['table'] = 'user_group';
	$config['database']['user_group']['join'] = 'user_group.ugrp_id';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privileges']['table'] = 'user_privilege';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privilege_users']['table'] = 'user_privilege_user';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privilege_groups']['table'] = 'user_privilege_group';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_sess']['table'] = 'user_login_session';
	$config['database']['user_sess']['join'] = 'user_login_session.usess_uacc_fk';
	...
	*/
    $config['database']['custom']['user_profile']['table'] = 'user_profile';
    $config['database']['custom']['user_profile']['primary_key'] = 'uprof_id';
    $config['database']['custom']['user_profile']['foreign_key'] = 'uprof_users_uacc_fk';
    $config['database']['custom']['user_profile']['join'] = 'user_profile.uprof_users_uacc_fk';
    $config['database']['custom']['user_profile']['custom_columns'] = array('first_name', 'last_name', 'gender', 'initials');
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('uacc_email', 'uacc_username');
	...
	*/
	$config['security']['static_salt'] = 'MGVmZDI4YzE1mYI';
	...
	*/
	$config['security']['database_salt_length'] = 15;
	...
	*/
	$config['security']['recaptcha_public_key']	= '6Lfoo-ISAAAAAEjUkpcxPK52Xgh_zvjVi58Xvcm7';
	$config['security']['recaptcha_private_key'] = '6Lfoo-ISAAAAADGSbSaCDWk2e-uhHEae2zWTtKxX'; 
	...
	*/
	$config['security']['recaptcha_language'] = 'de';
	...
	*/
	 ...
	 * @param: int
	*/
	$config['settings']['default_group_id'] = AUTH_USER_DEFAULT_GROUP;
	...
	*/
	...
	$config['email']['site_title'] = AUTH_EMAIL_FROM;
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = AUTH_EMAIL_REPLY;
	...
	*/
	$config['email']['email_type'] = AUTH_EMAIL_TYPE;
