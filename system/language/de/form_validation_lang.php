...
$lang['alpha_dash_space']   = 'Das Feld %s darf nur Buchstaben, Zahlen, Bindestriche, Leerzeichen und Unterstriche enthalten.';
...
$lang['regex_match']		= "Das Feld %s hat nicht das korrekte Format.";
$lang['is_unique'] 			= "Das Feld %s muss eindeutig sein.";
$lang['priv_name']          = "Das Feld %s darf nur Buchstaben und Doppelpunkte enthalten.";
$lang['edit_unique'] 		= "Das Feld %s muss eindeutig sein.";
$lang['decimal']			= "Das Feld %s muss eine Dezimalzahl enthalten.";
$lang['less_than']			= "Das Feld %s muss eine kleinere Zahl enthalten, als das Feld %s.";
$lang['greater_than']		= "Das Feld %s muss eine größere Zahl enthalten, als das Feld %s.";

/* End of file form_validation_lang.php */
/* Location: ./system/language/de/form_validation_lang.php */